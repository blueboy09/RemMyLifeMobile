...
public class TestWebService {
	...
	public static void test() {
		...
		//1: loginByName
		/*
		System.out.println(MA.callMethodInOutPrim(
				"loginByName",
				"userName", user1, false,
				"password", password1, false
				));
		*/
		if(MA.loginByName(user1, password1)){
		...
		//3: saveUser
		String userName ="yfjin@gmail.com";
