...
import com.remmylife.diary.*;
    ...
    public class ManagerAccess {
        ...
        public boolean shareDiary(Diary diary, User self){ // return type : void -> boolean
            return callMethodInOutPrim("shareDiary", "self",self, true);

        }
        
        public boolean unshareDiary(Diary diary, User self){ // return type : void -> boolean
            return callMethodInOutPrim("unshareDiary", "self",self, true);
        }
